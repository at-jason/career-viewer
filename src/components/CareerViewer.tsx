    ...
    <div
      <div className="text-center max-w-2xl mx-auto mb-8">
        ...
        <p className="text-gray-300">
          Modern careers aren't linear—they're collections of experiences that build complementary skills. 
          Select a focus area to explore my journey through different professional lenses, from product development 
          to analytics and operations.
        </p>
      </div>
